...
/*		String addedNde=addNumber("87675673456", "5432432321");
		...
		//String resultDiv=divideNumber("2472537583745867456456544564986745647698445646746846469847", "76347563475356353", '%');
		//System.out.println("Divison "+resultDiv);

		String resultRoot=doSquareRoot("267611489478248274687641531761249149611414");
		System.out.println("ROOT "+resultRoot);

		//String resultExp=ExponentialHandler("4", n);
		//System.out.println("EXPONENTIAL "+resultExp);
		
		
		/*Boolean resultCompare=compareNumberAsString("69483544537345", "77233432423400");
		System.out.println("Compare "+resultCompare);
		
		String[] resultQD=frameDivisorWithZero("69483544537345", "372334324234");
		System.out.println("Quotient "+resultQD[0]);
		System.out.println("Divisor "+resultQD[1]);*/
